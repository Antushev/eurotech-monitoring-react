  ...
  return (
    <>
      ...
      <div className="modal">
        ...
        <h2 className="header header--2 header--center header--space-bottom">Добавление товара</h2>

        <label className="input-label" htmlFor="group-name">Введите название нового товара</label>
        <input
          ref={inputRef}
          className="input"
          name="product-name"
        ...
        >
          {
            isLoadProduct ? <Preloader /> : 'Добавить товар'
          }
        </button>
      </div>
    </>
